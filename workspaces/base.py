...
class BaseWorkspace:
    ...
    @property
    def output_dir(self):
        # Returns the output directory, using the one set at init or the one provided by Hydra runtime.
    ...
    def save_checkpoint(
        ...
        Args:
            ...
            exclude_keys (_type_, optional): _description_. Defaults to None.
            include_keys (_type_, optional): _description_. Defaults to None.
            use_thread (bool, optional): _description_. Defaults to True.
